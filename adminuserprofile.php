...
<body>
	...
	<div id="div1">
		<h1><img src="images/profile.png" alt="User Profile"> </h1>
		<h2 style="text-align: center"><strong>WELCOME ADMIN</strong></h2>
	       <hr>
	...
	<div id="div2"><a href="admin.php" class="btn btn-dark btn-lg">Back</a></div>
	<div id="div3">
			<hr>
		<footer id="contact">
	<h3>Contact Us</h3>
